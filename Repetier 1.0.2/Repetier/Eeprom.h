...
#define EPR_XAXIS_STEPS_PER_MM      3  //3
#define EPR_YAXIS_STEPS_PER_MM      7   //7
#define EPR_ZAXIS_STEPS_PER_MM     11  //11
#define EPR_X_MAX_FEEDRATE         15  //15
#define EPR_Y_MAX_FEEDRATE         19  //19
