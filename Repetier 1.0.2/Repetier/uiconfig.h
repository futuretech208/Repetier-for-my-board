...
//Use for Reprap discount smart controller (20x04 display)
...
#define UI_ENCODER_CLICK       50
#define UI_RESET_PIN           -1
#define UI_DELAYPERCHAR 50
#define UI_INVERT_MENU_DIRECTION 0
#define UI_BUTTON_BACK         -1

//end for reprapdiscount smart controller

//Defined for reprap full graphics smart controller 12864 display
//    #else
//    #undef SDSS
//    #define SDSS            4  
//    #undef SPI_PIN
...
//End for reprap discount full graphics smart controller 12864 display
...
void uiInitKeys() {
#if UI_HAS_KEYS!=0
  UI_KEYS_INIT_CLICKENCODER_LOW(48,52); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
  UI_KEYS_INIT_BUTTON_LOW(50); // push button, connects gnd to pin
#endif
}
void uiCheckKeys(uint16_t &action) {
#if UI_HAS_KEYS!=0

 UI_KEYS_CLICKENCODER_LOW_REV(48,52); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
 UI_KEYS_BUTTON_LOW(50,UI_ACTION_OK); // push button, connects gnd to pin
#endif
}
